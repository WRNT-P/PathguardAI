...
├── APP_SYNC_2026-09-01.md           — บันทึกการคุยข้ามทีมกับคนที่ 1 (งานที่ต้องทำ + โค้ด Dart ร่างไว้ให้)
├── BACKEND_REPORT_2026-09-01.md     — รายงานว่าฝั่ง backend ทำอะไรไปบ้าง (คู่กับไฟล์ข้างบน)
│                                      ⚠️ ฉบับ 27–30 ส.ค. ถูกลบ 2 ก.ย. เพราะถูกแทนที่หมดแล้ว — ย้อนดูได้ใน git
│
